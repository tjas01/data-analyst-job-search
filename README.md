...
*Last updated: 2026-08-26 09:08 AM PST*

### Postings from the last 24 hours

**1. Chargebacks Data Analyst (BR) | Unknown | Remote | Unknown**
- Posted: Wed, 26 Au
- Link: https://jobicy.com/jobs/151736-chargebacks-data-analyst-br
- Match score: 6/10
- Why this fits: Moderate keyword match (Python scorer, Gemini unavailable). Signals: title matches target analyst roles.

**2. Chargeback Data Analyst (MX) | Unknown | Remote | Unknown**
- Posted: Wed, 26 Au
- Link: https://jobicy.com/jobs/151726-chargeback-data-analyst-mx
- Match score: 6/10
- Why this fits: Moderate keyword match (Python scorer, Gemini unavailable). Signals: title matches target analyst roles.
